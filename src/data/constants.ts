...
export const ATTACHMENTS: Record<string, Attachment> = {
  'Objetiva': { name: 'Objetiva', points: 2, description: '+20% hit, +10% crit, proibido em Curta (Rifle/Fuzil)', hitBonus: 20, critBonus: 10, weaponClasses: ['Rifle', 'Fuzil'], minRange: 20 },
  'Red Dot': { name: 'Red Dot', points: 2, description: '+10% hit até 40m (Fuzil/Sub)', hitBonus: 10, weaponClasses: ['Fuzil', 'Submetralhadora'], maxRange: 40 },
  'Grip': { name: 'Grip', points: 2, description: '+5% hit (Fuzil/Sub)', hitBonus: 5, weaponClasses: ['Fuzil', 'Submetralhadora'] },
  'Bi-pé': { name: 'Bi-pé', points: 2, description: '+5% crit se deitado (Rifle/Fuzil)', critBonus: 5, weaponClasses: ['Rifle', 'Fuzil'], requireProne: true },
};
