...
7. BROWN (#8B4513) = CLOSED DOORS
   → Solid closed doors connecting structures. Should look like paths that are currently blocked by a physical door.
   
8. LIGHT BROWN (#D2B48C) = OPEN DOORS
   → Open doorways, visible frames with clear passage.

9. CYAN (#00FFFF) = WINDOWS
   → Window frames, shattered glass, or openings in walls that provide partial cover but let light through.
   
10. WHITE/EMPTY = OPEN TERRAIN
...
- "doorClose" = Closed doors (solid, blocking)
- "doorOpen" = Open doorways (open passage)
- "window" = Windows, shattered openings in walls
